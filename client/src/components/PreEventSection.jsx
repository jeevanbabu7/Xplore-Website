    ...
    <section className='flex justify-center items-center min-h-screen bg-gray-300 py-10'>
      <div className='text-center'>
        ...
        <button
          ...
          className='px-20 py-8 bg-green-600 text-white text-xl font-semibold rounded-md hover:bg-green-700 transition-all duration-300 ease-in-out shadow-lg transform hover:scale-105'
        >
